    ...
    <Form {...form}>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                ...
                >
                  <SelectTrigger>
                    <SelectValue placeholder={loadingBarbers ? 'Carregando...' : 'Selecione um barbeiro'} />
                  </SelectTrigger>
                  <SelectContent>
                    {barbers.map((b) => (
        ...
        <Button type="submit" className="w-full" disabled={form.formState.isSubmitting}>
          {form.formState.isSubmitting ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : 'Registrar Venda'}
        </Button>
      </form>
    </Form>
  );
