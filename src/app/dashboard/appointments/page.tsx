  ...
  import { fetchAppointments, fetchBarbers, fetchServices, deleteAppointment } from '@/lib/fetcher';
  ...
  export default function AppointmentsPage() {
    ...
    const columns = getColumns(barbers, services, openDeleteConfirm, openCompleteConfirm, handleEditAppointment);
            ...
            <DialogContent className="max-h-[90vh] overflow-y-auto">
              <DialogHeader>
                ...
                <DialogDescription>
                  ...
                  {selectedAppointment ? 'editar o agendamento selecionado.' : 'adicionar um novo agendamento.'}
                </DialogDescription>
              </DialogHeader>
              <AppointmentForm
                barbers={barbers}
